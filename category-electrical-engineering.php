<?php
/**
 * Template Name: Electrical Engineering
 *
 * Description:   makes category full page
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Electrical Engineering</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '87'));

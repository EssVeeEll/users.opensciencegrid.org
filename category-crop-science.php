<?php
/**
 * Template Name: Crop Science
 *
 * Description:   makes crop science category page full screen
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Crop Science</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '67'));

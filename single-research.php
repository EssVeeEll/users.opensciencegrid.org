<?php
/**
 * Template Name: Research Post Template
 *
 * Description:   Template for research posts, takes away sidebar.
 *
 *
 * @package WordPress
 * 
     ...
     <?php while (have_posts()) : the_post(); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <section>
                        <h2 class="page-header no-margin-top fixed"><?php the_title(); ?><br>

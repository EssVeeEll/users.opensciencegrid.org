...
* if you put "thumbnail" in as a parameter, you get the thumbnail.
* if not, you get the full image.
*/
...
* also accepts 'thumbnail' as a parameter in the same way.
*/
		...
		<div class = "tab-content">
			...
			foreach($posts as $post): setup_postdata($post);?>
				...
				<?php else: $url = get_stock_feature_url(); ?>
					<img src="<?php echo $url; ?>" class="img-responsive imageborder" alt="No image">
				<?php endif; ?>
				</a>
				<a href = "<?php the_permalink(); ?>"><?php the_title(); ?></a>
				
<?php /*do_shortcode('[post-list posts_per_page="3" orderby="rand"]'); */?>
                </div>

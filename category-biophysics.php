<?php
/**
 * Template Name: Biophysics
 *
 * Description:   makes biophysics category full screen
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Biophysics</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '78'));

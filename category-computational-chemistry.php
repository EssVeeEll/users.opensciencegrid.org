<?php
/**
 * Template Name: Computational Chemistry
 *
 * Description:   Makes computational chemistry page full screen.
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Computational Chemistry</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '53'));

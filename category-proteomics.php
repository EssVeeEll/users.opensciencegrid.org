<?php
/**
 * Template Name: Proteomics
 *
 * Description:   makes proteomics category page full screen
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Proteomics</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '79'));

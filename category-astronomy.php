<?php
/**
 * Template Name: Astronomy
 *
 * Description:   makes astronomy category full page
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Astronomy</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '84'));

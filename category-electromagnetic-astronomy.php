<?php
/**
 * Template Name: Electromagnetic Astronomy
 *
 * Description:   makes category full screen
 *
...
<header class="main-header">
    <div class="container">
        <h1 class="page-title">Electromagnetic Astronomy</h1>
...
<?php
    ...
    query_posts(array('paged' => get_query_var('paged'), 'cat' => '83'));
